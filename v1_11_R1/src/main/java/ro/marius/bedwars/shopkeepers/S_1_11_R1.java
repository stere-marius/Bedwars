...
public class S_1_11_R1 extends EntitySkeleton implements IShopKeepers {

    static {
        NMSUtils11.registerEntity(NMSUtils11.Type.SKELETON, S_1_11_R1.class, false);
    }

    public S_1_11_R1(World world) {
        super(world);
