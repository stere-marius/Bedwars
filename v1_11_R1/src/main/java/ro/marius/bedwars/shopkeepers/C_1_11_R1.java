...
public class C_1_11_R1 extends EntityCreeper implements IShopKeepers {

    static {
        NMSUtils11.registerEntity(NMSUtils11.Type.CREEPER, C_1_11_R1.class, false);
    }

    public C_1_11_R1(World world) {
        super(world);
