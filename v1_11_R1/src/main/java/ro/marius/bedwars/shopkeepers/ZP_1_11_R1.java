...
public class ZP_1_11_R1 extends EntityPigZombie implements IShopKeepers {

    static {
        NMSUtils11.registerEntity(NMSUtils11.Type.PIG_ZOMBIE, ZP_1_11_R1.class, false);
    }

    public ZP_1_11_R1(World world) {
        super(world);
