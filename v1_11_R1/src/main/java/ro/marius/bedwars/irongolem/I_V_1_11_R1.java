...
public class I_V_1_11_R1 extends EntityIronGolem implements ICustomGolem {

    static {
        addToMaps();
    }

    public I_V_1_11_R1(World world) {
        super(world);
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomGolem",
                I_V_1_11_R1.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(I_V_1_11_R1.class,
                "CustomGolem");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null))
                .put(I_V_1_11_R1.class, 99);
    }
