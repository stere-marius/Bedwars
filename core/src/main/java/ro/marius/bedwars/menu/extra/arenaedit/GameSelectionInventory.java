...
public class GameSelectionInventory extends ExtraInventory {
    ...
    public Inventory getInventory() {
        Inventory inventory = Bukkit.createInventory(this, 36, Utils.translate("&eArena selection"));
