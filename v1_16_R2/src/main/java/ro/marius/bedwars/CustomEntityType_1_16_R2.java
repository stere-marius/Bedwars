...
public class CustomEntityType_1_16_R2<T extends EntityLiving> {
    ...
    public CustomEntityType_1_16_R2(String name, Class<T> customEntityClass, EntityTypes<? super T> parentType,
