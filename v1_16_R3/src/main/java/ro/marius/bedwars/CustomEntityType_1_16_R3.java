...
public class CustomEntityType_1_16_R3<T extends EntityLiving> {
    ...
    public CustomEntityType_1_16_R3(String name, Class<T> customEntityClass, EntityTypes<? super T> parentType,
