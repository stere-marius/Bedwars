...
public final class NMSUtils {
     ...
     * <p>
     * Unlike the other method, this allows you to choose the 'category' of your
     * mob; Creature, Monster, Ambient or Water Creature - even if it in reality was
     * none of those.
     * <p>
     ...
     * @param meta   - The category in which your mob'll spawn (i.e creatures'll
     *               spawn in day, monsters during night..)
    ...
    /**
     * Registers your entity without an internal id like most of the mobs have. Not
     * sure where you'd need this but here you go.
     * <p>
     * Can still be spawned via /summon.
     *
     * <p>
     * <b>Note: </b>Since no mob Type can be provided, overriding default mobs is
     * not possible.
     *
     ...
     * @param override    - Should your mob be set as a default in each biome? Only
     *                    one custom entity of this type entity can have this set as
     *                    'true'.
     */
     ...
     * Registers the custom class to be available for use.
     *
     * @param id          - The mob id. BE CAREFUL with this. Your Minecraft client
     *                    renders the entity based on this, and if used improperly,
    ...
    public enum MobMeta {
        MONSTER(NMSUtils.META_LIST_MONSTER), CREATURE(NMSUtils.META_LIST_CREATURE),
        WATER_CREATURE(NMSUtils.META_LIST_WATER_CREATURE), AMBIENT(NMSUtils.META_LIST_AMBIENT), UNDEFINED(null);
    ...
    public enum Attributes {
        ...
        FOLLOW_RANGE("generic.followRange", GenericAttributes.FOLLOW_RANGE), LUCK("generic.luck", GenericAttributes.j),
        ARMOR("generic.armor", GenericAttributes.h), ARMOR_TOUGHNESS("generic.armorToughness", GenericAttributes.i),
