...
public class ZP_1_12_R1 extends EntityPigZombie implements IShopKeepers {

    static {
        NMSUtils.registerEntity("CustomPigman", Type.PIG_ZOMBIE, ZP_1_12_R1.class, false);
    }

    public ZP_1_12_R1(World world) {
        super(world);
