...
public class C_1_12_R1 extends EntityCreeper implements IShopKeepers {

    static {
        NMSUtils.registerEntity("CustomCreeper", Type.CREEPER, C_1_12_R1.class, false);
    }

    public C_1_12_R1(World world) {
        super(world);
