...
public class B_1_12_R1 extends EntityBlaze implements IShopKeepers {

    static {
        NMSUtils.registerEntity("CustomBlaze", NMSUtils.Type.BLAZE, B_1_12_R1.class, false);
    }

    public B_1_12_R1(World world) {
        super(world);
