...
public class S_1_12_R1 extends EntitySkeleton implements IShopKeepers {

    static {
        NMSUtils.registerEntity("CustomSkeleton", Type.SKELETON, S_1_12_R1.class, false);
    }

    public S_1_12_R1(World world) {
        super(world);
