...
public class Z_1_12_R1 extends EntityZombie implements IShopKeepers {

    static {
        NMSUtils.registerEntity("CustomBlaze", Type.ZOMBIE, Z_1_12_R1.class, false);
    }

    public Z_1_12_R1(World world) {
        super(world);
