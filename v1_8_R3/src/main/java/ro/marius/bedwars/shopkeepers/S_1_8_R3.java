...
public class S_1_8_R3 extends EntitySkeleton implements IShopKeepers {
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomSkeleton",
                S_1_8_R3.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(S_1_8_R3.class,
                "CustomSkeleton");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null)).put(S_1_8_R3.class,
                51);
    }
