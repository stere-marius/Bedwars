...
public class I_V_1_9_R2 extends EntityIronGolem implements ICustomGolem {
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomGolem",
                I_V_1_9_R2.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(I_V_1_9_R2.class,
                "CustomGolem");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null)).put(I_V_1_9_R2.class,
                99);
    }
