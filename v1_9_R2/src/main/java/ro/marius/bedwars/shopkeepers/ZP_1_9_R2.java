...
public class ZP_1_9_R2 extends EntityPigZombie implements IShopKeepers {

    static {
        addToMaps();
    }

    public ZP_1_9_R2(World world) {
        super(world);
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomPigman",
                ZP_1_9_R2.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(ZP_1_9_R2.class,
                "CustomPigman");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null)).put(ZP_1_9_R2.class,
                57);
    }
