...
public class B_1_9_R2 extends EntityBlaze implements IShopKeepers {

    static {
        addToMaps();
    }

    public B_1_9_R2(World world) {
        super(world);
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomBlaze",
                B_1_9_R2.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(B_1_9_R2.class,
                "CustomBlaze");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null)).put(B_1_9_R2.class,
                61);
    }
