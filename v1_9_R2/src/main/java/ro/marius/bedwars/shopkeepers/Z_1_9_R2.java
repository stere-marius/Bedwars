...
public class Z_1_9_R2 extends EntityZombie implements IShopKeepers {

    static {
        addToMaps();
    }

    public Z_1_9_R2(World world) {
        super(world);
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomZombie",
                Z_1_9_R2.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(Z_1_9_R2.class,
                "CustomZombie");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null)).put(Z_1_9_R2.class,
                54);
    }
