...
public class C_1_10_R1 extends EntityCreeper implements IShopKeepers {

    static {
        addToMaps();
    }

    public C_1_10_R1(World world) {
        super(world);
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomCreeper",
                C_1_10_R1.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(C_1_10_R1.class,
                "CustomCreeper");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null))
                .put(C_1_10_R1.class, 50);
    }
