...
public class B_1_10_R1 extends EntityBlaze implements IShopKeepers {

    static {
        addToMaps();
    }

    public B_1_10_R1(World world) {
        super(world);
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomBlaze",
                B_1_10_R1.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(B_1_10_R1.class,
                "CustomBlaze");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null))
                .put(B_1_10_R1.class, 61);
    }
