...
public class V_1_10_R1 extends EntityVillager implements IShopKeepers {

    static {
        addToMaps();
    }

    public V_1_10_R1(World world) {
        super(world);
    ...
    private static void addToMaps() {
        ((Map<String, Class<?>>) ReflectionUtils.getPrivateField("c", EntityTypes.class, null)).put("CustomVillager",
                V_1_10_R1.class);
        ((Map<Class<?>, String>) ReflectionUtils.getPrivateField("d", EntityTypes.class, null)).put(V_1_10_R1.class,
                "CustomVillager");
        ((Map<Class<?>, Integer>) ReflectionUtils.getPrivateField("f", EntityTypes.class, null))
                .put(V_1_10_R1.class, 120);
    }
